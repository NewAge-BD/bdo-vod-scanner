...
Render synchronization event text with accessible colors inspired by BDO's in-game system chat: family names in gold, kill verbs and guild names in cyan, only the word **slain** in warm red, and structural details in a legible neutral grey. Phrase deaths as **Family was slain by Family**, keeping **was** and **by** white, and retain **from Guild** in the detailed selected event. Apply the same semantic coloring to the selected event and the matching-event list without relying on color alone to convey the event verb.
