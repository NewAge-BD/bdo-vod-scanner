...
- Increased the synchronization side panel's instructional, event, control, and status text for better desktop readability.
- Added an optional Ko-fi support link to the global footer.
