...
- Consolidated each kill burst into one centered, staggered banner spanning its first through final kill, and moved video controls into a dedicated bar outside the picture.
